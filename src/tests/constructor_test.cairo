...
fn test_constructor__should_panic_with_zero_address_owner() {
    ...
    // When
    ERC721::constructor(TOKEN_SYMBOL, CONTRACT_NAME, zero, one);
}
...
fn test_constructor__should_panic_with_zero_address_eth() {
    ...
    // When
    ERC721::constructor(TOKEN_SYMBOL, CONTRACT_NAME, one, zero);
}
...
fn test_constructor() {
    ...
    // When
    ERC721::constructor(TOKEN_SYMBOL, CONTRACT_NAME, caller, expected_eth_address);
